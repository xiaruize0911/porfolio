...
\title{Text2Sign: A Practical Single-GPU Diffusion Architecture for Text-to-Sign Language Video Generation}
\author{
\uppercase{Ruize Xia}
...
\markboth
{Xia: Text2Sign---Practical Single-GPU Diffusion for Sign Language Video}
{Xia: Text2Sign---Practical Single-GPU Diffusion for Sign Language Video}
